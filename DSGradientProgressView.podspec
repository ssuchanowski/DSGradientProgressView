#
#  Be sure to run `pod spec lint DSGradientProgressView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Dhol Studio"
  # s.authors            = { "Dhol Studio" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Dhol Studio"
